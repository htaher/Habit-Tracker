...
public class EditorActivity extends AppCompatActivity {
    ...
    /**
     * EditText field to enter the habit's duration in minute
     */
    private EditText mDurationEditText;

    /**
     * Spinner to select the habit's frequency
     */
    private Spinner mFrequencySpinner;

    /**
     * Frequency of the habit. The possible valid values are in the HabitContract.java file:
     * {@link HabitEntry#FREQ_SINGLE_TIME} or {@link HabitEntry#FREQ_EVERYDAY}.
     */
    private int mFrequency = HabitEntry.FREQ_SINGLE_TIME;
        ...
        mFrequencySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.frequency_single_time))) {
                        mFrequency = HabitEntry.FREQ_SINGLE_TIME;
                    } else if (selection.equals(getString(R.string.frequency_everyday))) {
                        mFrequency = HabitEntry.FREQ_EVERYDAY;
                    }
                }
            }
